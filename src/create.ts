...
export const resolved = <A = any>(value: A): Promise<A> => Promise.resolve(value)
export const rejected = <E extends Error = Error>(error: E): Promise<never> => Promise.reject(error)
